...
%
For instance, tools like \emph{MegaDeTH} or \emph{DRAGEN} will synthesize random
...
\item We provide a Template Haskell tool for automatically
  deriving all the required machinery presented throughout this paper, and
  evaluate its generation performance using three real-world case studies
