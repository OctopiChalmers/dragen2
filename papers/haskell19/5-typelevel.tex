...
not know the actual type names until they are synthesized during compilation,
due to their unique suffixes.
%
...
% The biggest different appears when deriving the required type instances for
% the |Con|, |Fun| and |Pat| synonyms.
%
