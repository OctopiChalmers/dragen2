...
Vector $E[G_0]$ represents the initial distribuition of constructors that our
...
%
We note |simplify#1| and |simplify#2| to the patterns occurring in the first and
...
arbitrary function.
%without solving the halting problem in the process.
