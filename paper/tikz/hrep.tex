...
% Text Node
\draw (85,133.5) node [scale=0.8]  {$\text{\textbf{module}}\ \mathrm{M}$};
% Text Node
\draw (100,159.5) node [scale=0.8]  {$\text{\textbf{data}}\ \mathrm{Html}\ =\ ... $};
% Text Node
\draw (107,219.5) node [scale=0.8]  {$\mathrm{div}::\mathrm{Html}\rightarrow \mathrm{Html}$};
% Text Node
\draw (109,233.5) node [scale=0.8]  {$\mathrm{bold}::\mathrm{Html}\rightarrow \mathrm{Html}$};
% Text Node
\draw (84,246.5) node [scale=0.8]  {$\mathrm{hr}::\mathrm{Html}$};
% Text Node
\draw (275.5,140) node [scale=0.8] [align=center] {$\mathrm{Html}$ \text{generation}\\ \text{description}};
% Text Node
\draw (276,165) node [scale=0.8]  {$\mathrm{Html_{ADT}}$};
% Text Node
\draw (276,200) node [scale=0.8]  {$\mathrm{Html_{Patterns}}$};
% Text Node
\draw (276,235) node [scale=0.8]  {$\mathrm{Html_{Interface}}$};
% Text Node
\draw (276,182.5) node   {$\boldsymbol{\oplus}$};
% Text Node
\draw (276,217.5) node   {$\boldsymbol{\oplus}$};
% Text Node
\draw (405.5,133.5) node [scale=0.8]  {$\text{Generator}$};
% Text Node
\draw (406,178) node   {$\boldsymbol{\oplus}$};
% Text Node
\draw (406,217.5) node   {$\boldsymbol{\oplus}$};
% Text Node
\draw (523,140) node [scale=0.8] [align=left] {$\mathrm{Html}$\\\text{test cases}};
% Text Node
\draw (107,184.5) node [scale=0.8]  {$\mathrm{simplify}\ ( ...) \ =\ ... \ $};
% Text Node
\draw (107,198.5) node [scale=0.8] {$\mathrm{simplify}\ ( ...) \ =\ ... \ $};
% Text Node
\draw (202.5,142.5) node [scale=0.7] [align=center] {\textbf{Structure}\\\textbf{specification}};
% Text Node
\draw (348.5,169.5) node [scale=0.7] [align=center] {\textbf{Generator}\\ \textbf{derivation}};
% Text Node
\draw (466,168.5) node [scale=0.7] [align=center] {\textbf{Random} \\ \textbf{generation}};
% Text Node
\draw (348,245) node [scale=0.7] [align=center] {\textbf{User desired} \\ \textbf{distribution}};
