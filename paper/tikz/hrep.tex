...
\draw  [fill={rgb, 255:red, 226; green, 226; blue, 226 }  ,fill opacity=1 ] (340,255) -- (340,195) -- (335,195) -- (345,195) -- (355,195) -- (350,195) -- (350,255) -- cycle ;
...
% Text Node
\draw (100,184.5) node [scale=0.8]  {$simpl\ ( ...) \ =\ ... \ $};
% Text Node
\draw (100,198.5) node [scale=0.8]  {$simpl\ ( ...) \ =\ ... \ $};
% Text Node
\draw (202.5,142.5) node [scale=0.7] [align=left] {\textbf{Structure}\\ \textbf{reification}};
% Text Node
...
% Text Node
\draw (346.5,272.5) node [scale=0.7] [align=left] {\textbf{User desired} \\ \textbf{distribution}};
