...
To exemplify the first source of structural information, consider that we want
to use randomly generated |Html| values to test a function |simplify :: Html ->
Html|.
%
...
%
Pattern matching allows to define functions idiomatically by defining different
...
%
After all, most of the \emph{valid structure} of values has been encoded into
