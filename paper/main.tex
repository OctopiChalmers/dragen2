...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;{H\!Rep}_{Val}\;{}\<[16]%
\>[16]{}\Varid{r}\mathrel{=}{Mk}_{Val}\;\Conid{Int}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;{H\!Rep}_{Add}\;{}\<[16]%
\>[16]{}\Varid{r}\mathrel{=}{Mk}_{Add}\;\Varid{r}\;\Varid{r}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;{H\!Rep}_{Mul}\;{}\<[16]%
\>[16]{}\Varid{r}\mathrel{=}{Mk}_{Mul}\;\Varid{r}\;\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
%
In first place, we define a type combinator (\ensuremath{\_^\bigstar}) to tag a \ensuremath{\text{HRep}} to be
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;(f^\bigstar)\;\Varid{a}\mathrel{=}\Conid{Term}\;(\Varid{f}\;\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{alignat*}{4}
  ...
  &\evalrep{Term\ x &&: \ensuremath{f^\bigstar}    &&}{t} &&= \evalrep{x : f}{t}
\end{alignat*}
...
With the introduced combinators, we can easily create a type synonym \ensuremath{{H\!Rep}_{Exp}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;{H\!Rep}_{Exp}{}\<[16]%
\>[16]{}\mathrel{=}{}\<[24]%
\>[24]{}{H\!Rep}_{Val}^\bigstar{}\<[E]%
\\
\>[16]{}\!\;\oplus\;{}\<[24]%
\>[24]{}{H\!Rep}_{Add}\;{}\<[34]%
...
However, a value of type \ensuremath{{H\!Rep}_{Exp}} still has its recursive calls abstracted
away---the type parameter \ensuremath{\Varid{r}} is implicit in the definition of \ensuremath{{H\!Rep}_{Exp}}.
%
...
generation of the inner \ensuremath{\text{HRep}}, and calling itself to generate recursive values:
...
\>[17]{}\Varid{x}\leftarrow genFix_{\,\text{HRep}_{Exp}}{}\<[E]%
\\
...
%
Consider the function \ensuremath{\Varid{foo}} defined in the previous section.
%
...
away every pattern variable of type \ensuremath{\Conid{Exp}}.
%
...
\column{18}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;{H\!Rep}_{foo\#1}\;{}\<[18]%
\>[18]{}\Varid{r}\mathrel{=}{Mk}_{foo\#1}\;\Varid{r}\;\Varid{r}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;{H\!Rep}_{foo\#2}\;{}\<[18]%
\>[18]{}\Varid{r}\mathrel{=}{Mk}_{foo\#2}\;\Conid{Int}\;\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

The first pattern of \ensuremath{\Varid{foo}} conteins two pattern variables (\ensuremath{\Varid{x}} and \ensuremath{\Varid{y}}) of type
\ensuremath{\Conid{Exp}} that are abstracted in the fields of \ensuremath{{Mk}_{foo\#1}}.
%
Similarly, the second pattern of \ensuremath{\Varid{foo}} contains the pattern variable \ensuremath{\Varid{x}} of type
\ensuremath{\Conid{Int}} represented by the first field of \ensuremath{{Mk}_{foo\#2}}, along with the pattern
variable \ensuremath{\Varid{y}} of type \ensuremath{\Conid{Exp}} that also is abstracted in the second field of
\ensuremath{{Mk}_{foo\#2}}.
...
%
\begin{align*}
  &\evalrep{\ensuremath{{Mk}_{foo\#1}}\ x\ y}{Exp} = \\
  &\ \ \ensuremath{\Conid{Add}\;(\Conid{Add}\;\evalrep{x}{Exp}\;(\Conid{Val}\;\mathrm{50}))\;(\Conid{Add}\;(\Conid{Val}\;\mathrm{25})\;\evalrep{y}{Exp})}\\
  &\evalrep{\ensuremath{{Mk}_{foo\#2}}\ x\ y}{Exp} = \\
  &\ \ \ensuremath{\Conid{Mul}\;(\Conid{Val}\;\mathrm{50})\;(\Conid{Mul}\;(\Conid{Val}\;\Varid{x})\;\evalrep{y}{Exp})}
\end{align*}

And the random generation of pattern \ensuremath{\text{HRep}}s is defined in the same way as we
did before with data constructors \ensuremath{\text{HRep}}s:
...
Finally, we can join the pattern matching representation of each clause of \ensuremath{\Varid{foo}}
into a single one:
...
\column{38}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;{H\!Rep}_{foo}{}\<[16]%
\>[16]{}\mathrel{=}{H\!Rep}_{foo\#1}\;\!\!\oplus\!\!\;{}\<[38]%
\>[38]{}{H\!Rep}_{foo\#2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
suppose we have a module \ensuremath{\Conid{M}} defining \ensuremath{\Conid{Exp}} combinators as follows:
...
We will represent each function of \ensuremath{\Conid{M}} returning a value of type \ensuremath{\Conid{Exp}} following
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{data}\;{H\!Rep}_{ten}\;{}\<[21]%
\>[21]{}\Varid{r}\mathrel{=}{Mk}_{ten}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;{H\!Rep}_{square}\;{}\<[21]%
\>[21]{}\Varid{r}\mathrel{=}{Mk}_{square}\;{}\<[37]%
\>[37]{}\Varid{r}{}\<[E]%
\\
\>[B]{}\mathbf{data}\;{H\!Rep}_{minus}\;{}\<[21]%
\>[21]{}\Varid{r}\mathrel{=}{Mk}_{minus}\;{}\<[37]%
...
%
As before, we abstract away any field representing and input of type \ensuremath{\Conid{Exp}} with
...
\begin{alignat*}{3}
  &\evalrep{\ensuremath{{Mk}_{ten}}         &&}{Exp} = \ensuremath{\Varid{ten}} \\
  &\evalrep{\ensuremath{{Mk}_{square}}\ x   &&}{Exp} = \ensuremath{\Varid{square}\;\evalrep{x}{Exp}} \\
  &\evalrep{\ensuremath{{Mk}_{minus}}\ x\ y &&}{Exp} = \ensuremath{\Varid{minus}\;\evalrep{x}{Exp}\;\evalrep{y}{Exp}}
\end{alignat*}

Moreover, the generation procedure for abstract interface representations
...
\>[3]{}gen_{ten}\;{}\<[15]%
\>[15]{}gen_{r}{}\<[22]%
\>[22]{}\mathrel{=}{Mk}_{ten}{}\<[E]%
\\
\>[3]{}gen_{square}\;{}\<[15]%
\>[15]{}gen_{r}{}\<[22]%
\>[22]{}\mathrel{=}{Mk}_{square}{}\<[35]%
\>[35]{}\mathop{\mathsmaller{\langle \$ \rangle}}\Varid{smaller}\;gen_{r}{}\<[E]%
\\
\>[3]{}gen_{minus}\;{}\<[14]%
\>[14]{}gen_{r}{}\<[22]%
\>[22]{}\mathrel{=}{Mk}_{minus}{}\<[35]%
...
\ensuremath{\Conid{M}} into a single one.
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;{H\!Rep}_{M}{}\<[14]%
\>[14]{}\mathrel{=}{H\!Rep}_{ten}\;\!\!\oplus\!\!\;{}\<[34]%
\>[34]{}{H\!Rep}_{square}\;\!\!\oplus\!\!\;{}\<[55]%
\>[55]{}{H\!Rep}_{minus}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Finally, we can put all the derived machinery together into a generation
specification \ensuremath{\Conid{Spec}} for the type \ensuremath{\Conid{Exp}}, assigning (possibly) different
generation frequencies to each individual \ensuremath{\text{HRep}} that constitutes it:
