...
%
Then, we provide a compositional approach to capture this information into our
automatically derived random generators.
%
More specifically, we propose a generation process that is capable to consider
how programs branch based on ADTs values' patterns as well as how they get
...
automatically synthesize \quickcheck generators for \emph{rich ADT values},
